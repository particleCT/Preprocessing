...
class pCT_Tracking {
  ...
  inline double quadExtrap(double x1, double x2, double x3, double x4,
    ...
    if (det == 0.) {
      std::cout << "pCT_Tracking::quadExtrap warning: a zero determinate was "
                   "encountered in making a quadratic exrapolation."
                << std::endl;
      return -9999.;
    }
  ...
  // V-U and T-U views.
  std::vector<Tkr2D> Tracking2D(int Idx, TkrHits &pCThits,
